...
?>
  <div style="display: flex; justify-content:center;">
    <img src="page.php/img/img-glace.jpg" alt="Jampi, artisan glacier" style="height: 144px; width: 180px; transform:rotate(-45deg);">
    ...
    <div style="height: 550px; display: flex; align-items: flex-end; margin-left: 50px;">
      <img src="page.php/img/img-glace.jpg" alt="Jampi, artisan glacier" style="height: 144px; width: 180px; transform:rotate(125deg);">
    </div>
  </div>
